...
var Component = (function (_React$Component) {
  ...
  Component.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    ...
    var should = nextState.value !== state.value || nextState.hasError !== state.hasError || nextState.error !== state.error || nextProps.options !== props.options || nextProps.type !== props.type || _util.isArraysShallowDiffers(nextPath, curPath);
  ...
  Component.prototype.getValue = function getValue() {
    var value = this.state ? this.state.value : this.getTransformer().format(this.props.value);
...
var Form = (function (_React$Component2) {
  ...
  Form.prototype.getComponent = function getComponent(path) {
    if (_tcombValidation2['default'].String.is(path)) {
